<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowMyHotel.aspx.cs" Inherits="HotelWebClient.ShowMyHotel" %>
...
<h2>My Hotel details</h2>
        ...
        <h2>My HotelRooms</h2>
         <asp:DataList ID="DataList1" runat="server" RepeatColumns="3" CellPadding="5" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
                  <div class="table1">                         
                <table >
                      <tr><td>  <asp:Image ID="Image1" runat="server" Height="250px" Width="300px" ImageUrl='<%#Eval("Image")%>'/></td></tr>  
                    <tr><td>Room Id: <asp:Label ID="RoomId1" runat="server" Text='<%#Eval("RoomId") %>' ></asp:Label></td></tr>
                    <tr>
                    ...
                    <tr><td><asp:linkbutton id="Linkbutton1" runat="server" commandname="Update" text="Update" ></asp:linkbutton></td> </tr>
                    <tr><td><asp:linkbutton id="Linkbutton2" runat="server" commandname="Delete" text="Delete Room" ></asp:linkbutton></td> </tr>
