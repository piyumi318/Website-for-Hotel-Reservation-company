<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyBooking.aspx.cs" Inherits="HotelWebClient.MyBooking" %>
...
<asp:DataList ID="Mybooking1" runat="server" RepeatColumns="3" CellPadding="2" OnItemCommand="My_ItemCommand">
            <ItemTemplate>
                ...
                <table>
                    ...
                    <tr><td><h3>Name: </h3><asp:Label ID="Label1" runat="server" Text='<%#Eval("FirstName") %>'></asp:Label>
                        <asp:Label ID="roomsize" runat="server" Text='<%#Eval("LastName") %>'> </asp:Label></td></tr>
                    <tr>
                      <td><h4>Address: </h4><asp:Label ID="price" runat="server" Text='<%#Eval("Address") %>'></asp:Label></td>
                      <td><h4>Country: </h4><asp:Label ID="Label2" runat="server" Text='<%#Eval("Country") %>'></asp:Label></td>  </tr>
                    <tr>
                        <td><h4>Email</h4><asp:Label ID="Label3" runat="server" Text='<%#Eval("Email") %>'  ></asp:Label></td>
                   ...
                   <tr><td><asp:linkbutton id="Linkbutton1" runat="server" commandname="Check" text="Show booke hoel and room"></asp:linkbutton></td>
