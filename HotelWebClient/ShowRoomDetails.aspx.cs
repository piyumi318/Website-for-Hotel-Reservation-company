...
{
    public partial class ShowRoomDetails : System.Web.UI.Page
    {
        ...
        protected void RadioButton3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            DataList2.DataSource = obj.RoomDetails();
            DataList2.DataBind();
        }
        protected void BtnFillter_Click(object sender, EventArgs e)
        {
            ...
            if (RadioButton1.Checked)
            {
                ...
                DataList2.DataSource = obj.FilterRoomType(data2); ;
                DataList2.DataBind();
            }
            else if (RadioButton2.Checked)
            {
                ...
                DataList2.DataSource = obj.FilterData(data1);
                DataList2.DataBind();
            }
