<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowRoomDetails.aspx.cs" Inherits="HotelWebClient.ShowRoomDetails" %>
...
<head runat="server">
    <title></title>
     ...
     <style>
        .table1 {margin-left:80px;
                 border:inset;
                 width:400px;
        }
        #Label5{font-size:32px;
                margin-left:500px;}
  </style>
</head>
<body>
    ...
    <form id="form1" runat="server">
        <asp:RadioButton ID="RadioButton3" runat="server" GroupName="filter" 
            Text="All Rooms" AutoPostBack="true" OnCheckedChanged="RadioButton3_CheckedChanged" />
        ...
        <asp:Button ID="BtnFillter" runat="server" Text="Filter" OnClick="BtnFillter_Click" />
         ...
         <asp:DataList ID="DataList2" runat="server" RepeatColumns="3" CellPadding="2" OnItemCommand="DataList2_ItemCommand">
            <ItemTemplate>
                ...
                <table >
                      <tr><td>  <asp:Image ID="Image1" runat="server" Height="250px" Width="400px" ImageUrl='<%#Eval("Image")%>'/></td></tr>  
                    <tr>
                    ...
                    <tr><td>Price:$ <asp:Label ID="price" runat="server" Text='<%#Eval("Price") %>' ></asp:Label></td> </tr>
                     ...
                     <tr><td><asp:Label ID="Label3" runat="server" Text="CheckIn"></asp:Label> 
                        ...
                        <tr><td><asp:linkbutton id="Linkbutton1" runat="server" commandname="Check" 
                            text="Check Avalibility" ></asp:linkbutton></td></tr>
